...
class ModelCook():
    ...
    def sell(self, recipes):
        ...
        """
        self.isplate = False
        if self._plate == recipes[self._recipe_counter]:
            if sum(self._plate) == 4:
                self._geld += 40
    ...
    def pick_up_item(self):
        ...
        if self._isplate: # if the player is holding a plate
            if 50 < self.spritecook.rect.x < 250 and self.spritecook.rect.y < 315: # if the plater is at the first ingredient station
    ...
    def put_down_item(self):
        if 760 < self.spritecook.rect.x < 910 and self.spritecook.rect.y > 500:
            ...
            controller.sell(recipes)

        if 655 < self.spritecook.rect.x < 800 and 300 < self.spritecook.rect.y < 500:
